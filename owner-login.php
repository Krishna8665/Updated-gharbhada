...
<section id="login" class="center_about">
    <div class="contains">
        ...
        <form class="form-signin" action="owner-auth.php"   method="POST">
            <div class="user-details">
              ...
              <div class="login">
                <button class="buttom" name="owner_login" type="submit" value="login">Login</button>
                
                <div class="signup">
                    Not a member? <a class="links" href="owner-register.php">Signup now</a>  
             </div>
          </form>
</section>
</body>
